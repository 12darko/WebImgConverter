...
export type SeoPageType = 'home' | 'heic-to-jpg' | 'png-to-jpg' | 'webp-to-jpg' | 'remove-background' | 'compress-image' | 'svg-to-png' | 'crop' | 'favicon-generator' | 'rotate-image' | 'watermark-image' | 'black-and-white';
