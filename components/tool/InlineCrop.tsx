...
const cropTranslations = {
    tr: {
        title: "✂️ Akıllı Kırpıcı",
        free: "Serbest",
        cropping: "Kırpılıyor...",
        downloaded: "İndirildi ✓",
        cropAndDownload: "Kırp ve İndir"
    },
    en: {
        title: "✂️ Smart Cropper",
        free: "Free",
        cropping: "Cropping...",
    ...
    de: {
        title: "✂️ Smarter Zuschneider",
        free: "Frei",
        cropping: "Zuschneiden...",
        downloaded: "Heruntergeladen ✓",
        cropAndDownload: "Zuschneiden & Speichern"
    },
    fr: {
        title: "✂️ Recadreur Intelligent",
        free: "Libre",
        cropping: "Recadrage...",
        downloaded: "Téléchargé ✓",
        cropAndDownload: "Recadrer & Télécharger"
    }
};
...
export const InlineCrop: React.FC<InlineCropProps> = ({ imageUrl, onCropComplete, onCancel }) => {
    ...
    // @ts-ignore
    const loc = cropTranslations[language] || cropTranslations.en;
        ...
        <div className="w-full bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden flex flex-col animate-[fadeIn_0.3s]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between p-4 md:p-6 border-b border-slate-100 dark:border-slate-800 gap-4">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2">
                    <button onClick={() => setAspectRatio(undefined)} className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${!aspectRatio ? 'bg-brand-50 dark:bg-brand-950/20 text-brand-700 dark:text-brand-300 border border-brand-200 dark:border-brand-800' : 'bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'}`}>{loc.free}</button>
