    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 animate-[slideUp_0.5s_ease-out]">
      <div className="max-w-4xl mx-auto bg-[#0f172a]/95 backdrop-blur-md border border-slate-700 rounded-xl shadow-2xl p-4 md:p-6 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex h-12 w-12 bg-brand-500/20 rounded-full items-center justify-center flex-shrink-0">
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            {t('cookie_message')}
            <a href="#" className="text-brand-400 hover:text-brand-300 ml-1 underline">{t('privacy')}</a>
          </p>
        </div>
        ...
        <div className="flex gap-3 w-full md:w-auto">
          ...
          <button
            ...
            className="flex-1 md:flex-none px-6 py-2 rounded-lg bg-brand-600 hover:bg-brand-500 text-white text-sm font-bold shadow-lg shadow-brand-900/30 transition-all active:scale-95"
          >
            {t('cookie_accept')}
          </button>
        </div>
