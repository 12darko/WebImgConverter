  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#0f172a] border border-slate-700 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-[fadeIn_0.3s]">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-brand-600 to-brand-600 px-6 py-4 flex justify-between items-center">
        ...
        <div className="p-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-gradient-to-r from-brand-600 to-brand-600 hover:from-brand-500 hover:to-brand-500 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-brand-500/25 active:scale-[0.98] disabled:opacity-50"
          >
            {isLoading ? (
