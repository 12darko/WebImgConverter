...
Monday - Friday: 09:00 - 18:00 (GMT+3)`
  ...
  de: {
    ...
    batch_convert_pro: "Stapelverarbeitung (Pro)",
        quality: "Qualität",
    smaller_file: "Kleinere Datei",
    higher_quality: "Höhere Qualität",
    // Navbar
    daily_credits: "Günlük Haklar",
    credits_label: "Kalan Kredi",
    premium_btn: "Premium'a Geç",
  ...
  fr: {
        opt_settings: "Paramètres d'optimisation",
    output_format: "Format de sortie",
    resize_dimensions: "Redimensionner",
    width: "Largeur",
    height: "Hauteur",
    lock_aspect_ratio: "Conserver les proportions",
    strip_metadata: "Supprimer les métadonnées (EXIF/GPS)",
    max_file_size: "Taille de fichier max",
    auto_quality: "Qualité auto",
    conversion_preview: "Aperçu de conversion",
    ...
    predicted: "Prévu",
    saved: "Économisé",
    upload_to_preview: "Télécharger une image",
    batch_convert_pro: "Conversion par lot (Pro)",
    quality: "Qualité",
    smaller_file: "Fichier plus petit",
    ...
    prem_price_btn: "Passer Premium ($0.99/Mois)",
    prem_no_thanks: "Continuer avec limites",
    premium_plans_title: "Plans Premium",
    premium_plans_subtitle: "Choisissez le plan qui vous convient le mieux",

    // Premium Plans
    plan_starter: "Starter",
    plan_pro: "Pro+ (Recommandé)",
    plan_business: "Business",
    price_mo: "/mois",
    feat_credits_30: "50 Crédits par jour",
    feat_credits_100: "100 Crédits par jour",
    feat_credits_unlimited: "Crédits Illimités",
    ...
    history_empty: "Aucun journal d'activité trouvé.",
