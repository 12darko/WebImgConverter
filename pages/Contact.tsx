...
const content = {
    ...
    de: {
        ...
        description: 'Kontaktieren Sie WebImgConverter. Wenden Sie sich an uns for Support und Fragen.',
        heading: 'Kontakt',
        intro: 'Sie können uns for Ihre Fragen, Vorschläge oder Support-Anfragen kontaktieren.',
        email: 'E-Mail',
        emailDesc: 'For allgemeine Fragen und Support:',
