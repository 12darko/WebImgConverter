...
const content = {
    tr: {
        title: 'Ýletiþim | WebImgConverter',
        description: 'WebImgConverter ile iletiþime geçin. Destek ve sorularýnýz için bize ulaþýn.',
        heading: 'Ýletiþim',
        intro: 'Sorularýnýz, önerileriniz veya destek talepleriniz için bizimle iletiþime geçebilirsiniz.',
        email: 'E-posta',
        emailDesc: 'Genel sorular ve destek için:',
        response: 'Yanýt Süresi',
        responseDesc: 'E-postalara genellikle 24-48 saat içinde yanýt veriyoruz.',
        faq: 'Sýk Sorulan Sorular',
        faqs: [
            { q: 'Dosyalarým güvende mi?', a: 'Evet. Tüm iþlemler güvenli geçici sunucularda anlýk olarak iþlenir ve hemen silinir.' },
            { q: 'Premium üyelik nasýl iptal edilir?', a: 'Premium üyeliðinizi Lemon Squeezy müþteri portalýndan iptal edebilirsiniz.' },
            { q: 'Hangi formatlarý destekliyorsunuz?', a: 'HEIC, PNG, JPG, WEBP, AVIF ve daha fazlasýný destekliyoruz.' }
        ]
    },
    en: {
