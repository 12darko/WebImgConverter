...
const content = {
    tr: {
        title: 'Kullaným Þartlarý | WebImgConverter',
        description: 'WebImgConverter kullaným þartlarý ve koþullarý.',
        heading: 'Kullaným Þartlarý',
        lastUpdated: 'Son Güncelleme: Ocak 2025',
        sections: [
            {
                title: 'Hizmet Tanýmý',
                content: 'WebImgConverter, geliþmiþ bir online görsel dönüþtürme ve düzenleme aracýdýr. Hizmetimiz HEIC, PNG, JPG, WEBP ve diðer formatlarda görsel dönüþümü, arka plan kaldýrma ve görsel sýkýþtýrma özelliklerini içerir.'
            },
            {
                title: 'Kabul Edilebilir Kullaným',
                content: 'Hizmetimizi yalnýzca yasal amaçlarla kullanabilirsiniz. Telif hakký ihlali içeren, yasa dýþý veya zararlý içeriklerin iþlenmesi için hizmetimizin kullanýlmasý yasaktýr.'
            },
            {
                title: 'Üyelik ve Krediler',
                content: 'Ücretsiz kullanýcýlar günlük kredi limitlerine tabidir. Premium üyeler ek özellikler ve artýrýlmýþ limitler alýr. Ödeme iþlemleri Lemon Squeezy tarafýndan güvenli bir þekilde gerçekleþtirilir.'
            },
            {
                title: 'Sorumluluk Reddi',
                content: 'Hizmetimiz "olduðu gibi" sunulmaktadýr. Dönüþtürme sonuçlarýnýn doðruluðu veya uygunluðu konusunda garanti vermiyoruz. Hizmetin kullanýmýndan kaynaklanan veri kaybý veya hasardan sorumlu deðiliz.'
            },
            {
                title: 'Ýade Politikasý (Refund Policy)',
                content: 'Dijital hizmetlerimizin anýnda teslimi ve kullanýmý sebebiyle, premium aboneliklerde genel bir iade politikamýz bulunmamaktadýr. Ancak teknik bir sorun yaþamanýz durumunda, satýn alma iþleminden sonraki 7 gün içinde support@WebImgConverter.com adresi üzerinden iade talebinde bulunabilirsiniz. Aboneliðinizi istediðiniz zaman iptal edebilirsiniz.'
            },
            {
                title: 'Deðiþiklikler',
                content: 'Bu þartlarý önceden haber vermeksizin deðiþtirme hakkýný saklý tutarýz. Önemli deðiþiklikler sitemizde duyurulacaktýr.'
            },
            {
                title: 'Ýletiþim',
                content: 'Sorularýnýz için support@WebImgConverter.com adresinden bize ulaþabilirsiniz.'
            }
        ]
    },
    en: {
