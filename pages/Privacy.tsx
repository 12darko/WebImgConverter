...
const content = {
    tr: {
        ...
        sections: [
            ...
            },
            {
                ...
                content: 'Güvenli sunucu mimarimiz, verilerinizin gizliliğini korurken en yüksek kaliteyi sunar. Sunucu taraflı işlemlerde veriler şifreli (SSL/TLS) olarak iletilir ve kalıcı olarak saklanmaz. işlem sonrası dosyalarınız otomatik olarak imha edilir.'
            },
            {
                title: 'İletişim',
    ...
    fr: {
        ...
        sections: [
            ...
            {
                title: 'Cookies',
                content: 'Notre site utilise des cookies essentiels pour améliorer l\'expérience utilisateur. Ces cookies sont utilisés pour mémoriser votre preference linguistique, l\'stat de la session et les paramètres du site. Google Analytics et Google AdSense peuvent également utiliser des cookies de performance et publicitaires.'
            },
            {
                title: 'Services Tiers',
                content: 'Les paiements d\'abonnement premium sont traités par Lemon Squeezy. Vos informations de paiement sont traitées directement sur les serveurs sécurisés de Lemon Squeezy; nous ne voyons ni ne stockons vos informations de carte de credit. Nous utilisons également les services Google Analytics (analyse de site) et Google AdSense (publicité).'
            },
            {
                title: 'Security des Données',
                content: 'Notre architecture de serveur sécurisée garantit une confidentialité maximale tout en fournissant des résultats de haute quality. Les données sont transmises avec un cryptage (SSL/TLS) et ne sont jamais stockées en permanence. Vos fichiers sont automatiquement détruits immédiatement après le traitement.'
            },
            {
                title: 'Contact',
                content: 'Pour des questions concernant notre politique de confidentialité, vous pouvez nous joindre h support@WebImgConverter.com.'
            }
        ]
    }
};
