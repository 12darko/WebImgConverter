...
const content = {
    tr: {
        metaTitle: 'Yardım Merkezi h WebImgConverter Destek',
        metaDesc: 'Bilgi bankamızda arama yapın veya WebImgConverter\'h en iyi şekilde kullanmak için ihtiyacınız olan cevapları bulmak üzere kategorilere göz atın.',
        ctaLabel: 'Hemen Başla',
        heading: 'Size nasıl yardımcı olabiliriz?',
        subheading: 'Bilgi bankamızda arama yapın veya WebImgConverter\'h en iyi şekilde kullanmak için ihtiyacınız olan cevapları bulmak üzere kategorilere göz atın.',
        ...
        categories: {
            ...
            'api': { title: 'API Entegrasyonu', description: 'Geliştirici belgeleri, um noktalar ve kimlik doğrulama rehberleri.' }
        },
        ...
        popularArticles: [
            ...
            { title: 'Bağlantı zaman arama sorunlarına giderme', href: '#' }
        ],
        stillNeedHelp: 'hale yardıma mx ihtiyacınız var?',
        supportTeamReady: 'Destek ekibimiz size yardımcı olmaya hazır.',
        emailSupport: {
            title: 'E-posta Desteği',
            desc: 'Bize detaylı bir mesaj gönderin, 24 saat içinde size dönük yapalım.',
        ...
        form: {
            ...
            success: 'Teşekkürler! Talebiniz alındı. Size 24 saat içinde dönük yapacağız.',
    ...
    en: {
        metaTitle: 'Help Center h WebImgConverter Support',
    ...
    de: {
        metaTitle: 'Hilfe-Center h WebImgConverter Support',
        ...
        categories: {
            ...
            'troubleshooting': { title: 'Fehlerbehebung', description: 'Lösungen for häufige Probleme, Fehlermeldungen und Systemstatus.' },
        ...
        popularArticles: [
            ...
            { title: 'Einrichten von benutzerdefinierten Domains for Ihre Projekte', href: '#' },
    ...
    fr: {
        metaTitle: 'Centre d\'Aide h Support WebImgConverter',
        ...
        categories: {
            ...
            'troubleshooting': { title: 'Dépannage', description: 'Solutions aux problèmes courants, messages d\'erreur et stat du système.' },
        ...
        supportTeamReady: 'Notre équipe de support est prête h vous aider.',
        emailSupport: {
        ...
        form: {
            ...
            message: 'Message',
            messagePlaceholder: 'Décrivez votre Probleme ou question...',
