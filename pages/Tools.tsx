...
const content = {
    tr: {
        ...
        tools: {
            ...
            'gemini-watermark-remover': { name: 'Gemini Filigran Silici', description: 'Google Gemini AI tarafından eklenen filigranları tek tıkla otomatik olarak kaldırın.' },
    ...
    en: {
        ...
        tools: {
            ...
            'gemini-watermark-remover': { name: 'Gemini Watermark Remover', description: 'Automatically remove watermarks added by Google Gemini AI with one click.' },
...
const TOOLS: ToolDef[] = [
    ...
    },
    {
        ...
        description: 'gemini-watermark-remover',
        ...
        keywords: ['gemini', 'watermark', 'ai', 'google', 'remove', 'eraser'],
    },
    {
        id: 'general-tool',
        name: 'general-tool',
